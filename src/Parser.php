...
use Ingress\Markdown\Drivers\MarkdownDriver;
use Ingress\Markdown\Exceptions\InvalidTagException;
...
class Parser
{
     ...
     * 
     * @param  \Ingress\Markdown\Drivers\MarkdownDriver  $driver
     */
     ...
     * 
     * @throws \Ingress\Markdown\Exceptions\InvalidTagException
     * @return string
     */
    public function end()
    {
